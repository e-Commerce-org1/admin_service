...
import { DashboardStats, ProductListResponse } from 'src/interfaces/dashboard.interface';
  ...
  async getDashboardStats(): Promise<DashboardStats> {
    try {
      ...
      if (!this.isProductListResponse(productResponse.data)) {
        ...
        this.logger.error('Invalid product data structure', productResponse.data);
